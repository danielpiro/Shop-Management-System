...
public class HumanResourceManager extends Employee {
    ...
    public HumanResourceManager(String f_Name, String l_Name, int id,
    ...
    public HumanResourceManager(FacadeHumanResourceManager facadeHumanResourceManager) {  //create new HumanResourceManager
    ...
    public HumanResourceManager(DalEmployee dalEmployee) {  //create new HumanResourceManager
    ...
    public void updateHRM(FacadeHumanResourceManager facadeHumanResourceManager) {
