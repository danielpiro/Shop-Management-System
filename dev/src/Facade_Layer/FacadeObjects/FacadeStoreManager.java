...
import Bussiness_Layer.EmployeePackage.StoreManager;

public class FacadeStoreManager extends FacadeEmployee {

    public FacadeStoreManager(String f_Name, String l_Name, int id,
    ...
    public FacadeStoreManager(StoreManager storeManager) {
        super(storeManager.getF_Name(), storeManager.getL_Name(), storeManager.getId(), storeManager.getWage(), storeManager.getMonthlyDayOffs(), storeManager.getMonthlySickDays(), storeManager.getBankInfo(), storeManager.getAdvancedStudyFunds(), storeManager.getBranch());
    }
    /*
